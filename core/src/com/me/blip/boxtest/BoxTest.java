...
public class BoxTest extends ApplicationAdapter
{
    ...
    public void create()
    {
        ...
        cam = new OrthographicCamera(/*parameters here that are like scaled based on a constant with width and height*/);
    ...
    public void update(float dt)
    {
        ...
        if(!contactListener.touchingGround)
        {
            //air drift
        }
    ...
    public void render()
    {
        ...
        sr.rect(player.getPosition().x * UPM -16,player.getPosition().y * UPM - 16,32,32);
        sr.end();
        */
